...
const closeElement = document.querySelector(".modal__closelcon");
...
const showResult = (userChoice, computerChoice) => {
  ...
  if (userChoice === computerChoice) {
    ...
    (userChoice === gameChoicesArray[0] &&
      computerChoice === gameChoicesArray[3]) ||
    (userChoice === gameChoicesArray[1] &&
      computerChoice === gameChoicesArray[4]) ||
    (userChoice === gameChoicesArray[1] &&
    ...
    (userChoice === gameChoicesArray[3] &&
      computerChoice === gameChoicesArray[2]) ||
    (userChoice === gameChoicesArray[3] &&
      computerChoice === gameChoicesArray[1]) ||
    (userChoice === gameChoicesArray[4] &&
      computerChoice === gameChoicesArray[3]) ||
    (userChoice === gameChoicesArray[4] &&
      computerChoice === gameChoicesArray[1])
  ) {
